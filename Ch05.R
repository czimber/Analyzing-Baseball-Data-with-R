...
data2011$RUNS
head(data2011$RUNS,100)
hist(data2011$RUNS,60)
data2011$AWAY_SCORE_CT

hist(data2011$EVENT_CD)
table(data2011$EVENT_CD)

table(data2011$PITCH_SEQ_TX)
...
head(data2011$HALF.INNING,100)
table(data2011$RUN3_DEST_ID)

data2011$RUNS.SC <- with(data2011, (RUN1_DEST_ID > 3) + (RUN2_DEST_ID > 3) + (RUN3_DEST_ID > 3))
names(data2011)
